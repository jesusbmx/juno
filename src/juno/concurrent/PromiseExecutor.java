...
public class PromiseExecutor<T> implements Runnable, Sender<T> {
    ...
    public PromiseExecutor(Executor<T> executor, Dispatcher dispatcher) {
        this.executor = executor;
        this.dispatcher = dispatcher;
    }
    
    public PromiseExecutor(Executor<T> executor) {
        this(executor, Dispatcher.get());
    }
   
    public PromiseExecutor<T> then(OnResponse<T> responseListener, OnError errorListener) {
