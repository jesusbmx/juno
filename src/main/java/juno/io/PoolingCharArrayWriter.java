 ...
 */
public class PoolingCharArrayWriter extends CharArrayWriter {
  ...
  private final CharArrayPool mPool;
   ...
   */
  public PoolingCharArrayWriter(CharArrayPool pool) {
   ...
   */
  public PoolingCharArrayWriter(CharArrayPool pool, int size) {
    mPool = pool;
  ...
  private void expand(int i) {
    ...
    char[] newbuf = mPool.getBuf((count + i) * 2);
